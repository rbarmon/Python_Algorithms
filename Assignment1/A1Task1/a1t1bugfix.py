...
class Min_Heap_Priority_Queue:
    ...
    Operations" section page 25. Slightly modified so that the Priority Queue tracks whether the node is capable of
    ...
    FIT1008 notes and adjusted to work with key-value arrays
...
def CarpoolDjikstra(graph, start, end, passengers):
            ...
            while temp:  # halts on None for adj node
                ...
                if dist[temp.vertexNo] > dist[
                    ...
                    if temp.vertexNo in passengers:
                        first_found_passenger_node.append(temp.vertexNo)
        ...
        # print(passenger_condition)
            ...
            while temp:  # halts on None for adj node
                ...
                if new_dist[temp.vertexNo] >= new_dist[u.index] + temp.double:
                    ...
                    if u.index in passengers:
                        potential_start_indices.append(u.index)
                    if u.index in passengers and potential_start_index is None:
                        potential_start_index = u.index
                    if temp.vertexNo in passengers and temp.vertexNo
    ...
    if passenger_condition is False or dist[end] <= new_dist[end]:
        ...
        if dist[end] is float('inf') or dist[end] > new_dist[end]:
            ...
            print(first_found_passenger_node)
